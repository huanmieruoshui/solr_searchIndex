 ...
 *
 */
public class Finder extends SuperTrimer{
public static final String NAME = "_finder_";
...
public static final String DIRECTLY = "D";
	...
	public String toDefineStr() {
		...
		if(this.reverse){
			sb.append(':');
			sb.append(toDefineString("r"));
		}else{
			sb.append(':');
			sb.append(toDefineString("d"));
		}
		sb.append(']');
		return sb.toString();
	}
	...
	public String toString(){
		return String.format("[Finder: prefix = '%s', suffix = '%s', third para = '%s']", 
